...
const AuthorCard = ({ author, fixW = true }: Props) => {
  return (
    <Link
      href={`authors/${author.slug}`}
      className={`card h-[176px] sm:h-[247px] bg-white shadow-sm group border border-black06 hover:shadow-lg
        ${fixW ? "w-[140px] sm:w-[194px]": "w-full"}
        `}
    >
