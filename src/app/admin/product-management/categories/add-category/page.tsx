    ...
    <div className="flex">
      ...
      <div className="bg-white rounded-md my-8 mx-auto w-[95%] sm:w-[50%]">
        ...
        <div className="px-6 py-3 space-y-2 sm:px-14 sm:py-8 sm:space-y-8 text-[#6F6E77] text-xs sm:text-sm">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-5 grid-flow-row gap-3 sm:gap-4">
            <div className="space-y-2 flex flex-col items-start">
              <label>In English Feature</label>
              <input type="checkbox" className="toggle toggle-primary" />
            </div>
            <div className="space-y-2 flex flex-col items-start">
              <label>Is Bangla Feature</label>
              <input type="checkbox" className="toggle toggle-primary" />
            </div>
            <div className="space-y-2 flex flex-col items-start">
