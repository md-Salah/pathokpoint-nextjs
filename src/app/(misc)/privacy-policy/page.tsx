  ...
  return (
    <div className="bg-white pb-10">
      <MiscHeader
        ...
        subtitle="Your data, our responsibility — safeguarding your privacy every step of the way."
      />
      <div className="mt-8 layout-container layout-px space-y-4 text-sm lg:text-base">
        ...
        <h3 className="text-lg lg:text-xl font-bold">Interpretation</h3>
        <p>
        ...
        <h3 className="text-lg lg:text-xl font-bold">Definitions</h3>
        ...
        <ul className="list-disc ml-8 space-y-4">
          ...
          <li>
            <p>
              ...
              Pathok Point, {social.Address.text}.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Pathok Point, accessible from{" "}
              <Link
        ...
        <h4 className="text-base lg:text-lg font-bold">Personal Data</h4>
        <p>
        ...
        <h4 className="text-base lg:text-lg font-bold">Usage Data</h4>
        ...
        <h4 className="text-base lg:text-lg font-bold">Law enforcement</h4>
        <p>
        ...
        <h2 className="text-xl lg:text-2xl font-bold">Children&apos;s Privacy</h2>
        <p>
        ...
        <ul className="list-disc ml-8 space-y-4">
          <li>
            <p>
              By email:
              <Link href={social.Email.href}>{social.Email.text}</Link>
            </p>
          </li>
          <li>
            <p>
